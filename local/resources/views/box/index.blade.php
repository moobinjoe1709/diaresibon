...
<div class="breadcrumb">
    <div class="breadcrumb-element">
        ...
        <a class="breadcrumb-item " href="#">รายการสินค้า (Pack list)</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"> รายการสินค้า (Pack list)</div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success" href="{{ route('box.edit',$box->bo_pd_id) }}" ><i class="fas fa-upload"></i></a>
                                    {{-- <a class="btn btn-success" href="{{ url('Loadbox').'/'.$box->bo_pd_id.'/'.$box->bo_pd_id }}" ><i class="fas fa-upload"></i></a> --}}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
