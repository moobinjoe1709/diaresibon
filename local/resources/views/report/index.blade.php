...
<div class="breadcrumb">
    <div class="breadcrumb-element">
        ...
        <a class="breadcrumb-item " href="#">รายการ Shipment</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">รายการ Shipment</div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success" href="{{ route('report.show',$box->bo_pd_id) }}" ><i class="fas fa-file-export" title="รายการ Load Container"></i></a>
