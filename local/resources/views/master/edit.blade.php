...
<div class="breadcrumb">
    <div class="breadcrumb-element">
        ...
        <a class="breadcrumb-item " href="#">แก้ไข Master Products</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('master',$masters->mt_id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="customer_name" name="customer_name">
                                    ...
                                    <option value="{{ $customer->ct_id }}" @if( $masters->ct_id ==$customer->ct_id )
                    ...
                    <div class="row">
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="type" name="type" placeholder="TYPE" value="{{ $masters->mt_type }}">
                                @if ($errors->has('type'))
                                <div class="mx-sm-3 mb-2">
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="size_wheel_mm" name="size_wheel_mm"
                                    placeholder="SIZE WHEEL (MM)" value="{{ $masters->mt_size_wheel_mm }}">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="size_wheel_inch" name="size_wheel_inch"
                                    placeholder="SIZE WHEEL (INCH)" value="{{ $masters->mt_size_wheel_inch }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="spec" name="spec" placeholder="SPEC" value="{{ $masters->mt_spec }}">
                                @if ($errors->has('spec'))
                                <div class="mx-sm-3 mb-2">
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inner" name="inner" placeholder="INNER (PCS)"
                                    value="{{ $masters->mt_packing_qty_inner }}">
                                @if ($errors->has('inner'))
                                <div class="mx-sm-3 mb-2">
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="outer" name="outer" placeholder="OUTER (PCS)"
                                    value="{{ $masters->mt_packing_qty_outer }}">
                                @if ($errors->has('outer'))
                                <div class="mx-sm-3 mb-2">
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="width_cm" name="width_cm" placeholder="WIDTH (CM)"
                                    value="{{ $masters->mt_diamension_box_width }}">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="length_cm" name="length_cm" placeholder="LENGTH (CM)"
                                    value="{{ $masters->mt_diamension_box_leght }}">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="highth_cm" name="highth_cm" placeholder="HIGHTH (CM)"
                                    value="{{ $masters->mt_diamension_box_higth }}">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cbm" name="cbm" placeholder="CBM (M2)"
                                    value="{{ $masters->mt_diamension_box_cbm }}">
                                @if ($errors->has('cbm'))
                                <div class="mx-sm-3 mb-2">
                                    <span class="text-danger" role="alert">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="net_weight" name="net_weight" placeholder="Net Weight (Kgs)"
                                    value="{{ $masters->mt_diamension_box_netweight }}">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gross_weight" name="gross_weight"
                                    placeholder="Gross  Weight (Kgs)" value="{{ $masters->mt_diamension_box_grossweight }}">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pallet_size1" name="pallet_size1">
                                    ...
                                    <option value="{{ $typepalate->tp_id }}" @if ($masters->mt_pallet_no1 == $typepalate->tp_id)
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pallet_size_1" name="pallet_size_1"
                                    placeholder="PALLET SIZE NO.1" value="{{ $masters->mt_pallet_size1 }}">
                                <br>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pallet_size2" name="pallet_size2">
                                    ...
                                    @foreach ($typepalates as $typepalate)
                                    <option value="{{ $typepalate->tp_id }}" @if ($masters->mt_pallet_no2==$typepalate->tp_id)
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pallet_size_2" name="pallet_size_2"
                                    placeholder="PALLET SIZE NO.2" value="{{ $masters->mt_pallet_size2 }}">
                                <br>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="pallet_size3" name="pallet_size3">
                                    ...
                                    @foreach ($typepalates as $typepalate)
                                    <option value="{{ $typepalate->tp_id }}" @if ($masters->mt_pallet_no3==$typepalate->tp_id)
                                        {{ 'selected' }} @endif>{{ $typepalate->tp_width.'x'.$typepalate->tp_length.' x
                                        '.$typepalate->tp_hieght.' CM-'.$typepalate->tp_weight.'kgs/PLT' }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pallet_size_3" name="pallet_size_3"
                                    placeholder="PALLET SIZE NO.3" value="{{ $masters->mt_pallet_size3 }}">
                                <br>
                    ...
                    <div class="text-right"><button type="submit" class="btn btn-primary">แก้ไข</button></div>
                </form>
            </div>
        </div>
    </div>
